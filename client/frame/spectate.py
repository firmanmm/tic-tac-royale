...
class Spectate(baseMod.IBase):
    ...
    def buildHistoryFrame(self) -> ttk.Frame:
        ...
        upBtn = tki.Button(upBtnFrame, text="UP", font=fontMod.Font.PawnGridFont, background="white",
                           command=self.upHistory)
        ...
        downBtn = tki.Button(downBtnFrame, text="DW", font=fontMod.Font.PawnGridFont, background="white",
                             command=self.downHistory)
